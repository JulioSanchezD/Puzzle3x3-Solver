...
class Node:
    ...
    def expand(self):
        return [(self.moveLeft(), "left"), (self.moveUp(), "up"), (self.moveRight(), "right"),
                (self.moveDown(), "down")]


if __name__ == "__main__":
    # grid = [[8, 6, 7], [2, 5, 4], [3, 0, 1]]
    ...
    puzzle = Puzzle(grid2, goal2, hamming=True, manhattan=True, linear=True)
    print(puzzle.isSolvable())
    grid3 = [[1, 2, 3], [0, 5, 4], [6, 7, 8]]
    goal3 = [[1, 2, 3], [8, 0, 4], [7, 6, 5]]
    puzzle = Puzzle(grid3, goal3, hamming=True, manhattan=True, linear=True)
    print(puzzle.isSolvable())
